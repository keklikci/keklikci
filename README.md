...
- [docs(project): document development and Spark usage](https://github.com/keklikci/customer-behavior-modeling-for-ecommerce/pull/4) on [keklikci/customer-behavior-modeling-for-ecommerce](https://github.com/keklikci/customer-behavior-modeling-for-ecommerce) (1 month ago)
- [refactor(cli): improve Spark script entry points](https://github.com/keklikci/customer-behavior-modeling-for-ecommerce/pull/3) on [keklikci/customer-behavior-modeling-for-ecommerce](https://github.com/keklikci/customer-behavior-modeling-for-ecommerce) (1 month ago)
- [test(features): add feature math helpers and tests](https://github.com/keklikci/customer-behavior-modeling-for-ecommerce/pull/2) on [keklikci/customer-behavior-modeling-for-ecommerce](https://github.com/keklikci/customer-behavior-modeling-for-ecommerce) (1 month ago)
- [build(tooling): configure uv ruff and pytest](https://github.com/keklikci/customer-behavior-modeling-for-ecommerce/pull/1) on [keklikci/customer-behavior-modeling-for-ecommerce](https://github.com/keklikci/customer-behavior-modeling-for-ecommerce) (1 month ago)
- [test(experiments): add anomaly detection coverage](https://github.com/keklikci/predictive-maintenance/pull/4) on [keklikci/predictive-maintenance](https://github.com/keklikci/predictive-maintenance) (1 month ago)
- [chore(tooling): configure uv and ruff](https://github.com/keklikci/predictive-maintenance/pull/3) on [keklikci/predictive-maintenance](https://github.com/keklikci/predictive-maintenance) (1 month ago)
